...
export const NPC_RELATIONSHIPS: NpcRelationship[] = [
  ...
  // 陳姐對玩家：認識但開始保持距離
  {
    ...
    npcB:    "player",
    type:    "observer",
    aKnowsB: "你認識玩家，他是你麵館的常客，你對他的評價不差。但最近風聲傳來了，說他的名字在那十四份通話記錄裡，每一份都有。你說話比以前少了，觀察比以前多了。你在等他說出一件只有真正在找真相的人才會知道的事。",
    bKnowsA: "陳姐認識你，但她聽到了風聲。她不評判，她在觀察，她在決定要不要相信你。",
    bidirectional: true,
  },

  // 鄭博對玩家：妻子是第一個失蹤者，直接評估
  {
    npcA:    "zhengbo",
    npcB:    "player",
    type:    "suspect_of",
    aKnowsB: "你妻子陳瑤是第一個失蹤者。通話記錄裡有玩家的號碼。你在評估他是不是殺了陳瑤，或者他是另一個被牽連的人。你的方式是讓他說話，說出只有實際知情者才說得出的細節。",
    bKnowsA: "鄭博的妻子是第一個失蹤者，你的名字在她最後的通話記錄裡。他在評估你，你能感覺到。",
    bidirectional: true,
  },

  // 莊河對玩家：有罪推定，但還沒關掉另一種可能性
  {
    npcA:    "zhuanghe",
    npcB:    "player",
    type:    "suspect_of",
    aKnowsB: "你知道那份通話記錄。你做過二十七年刑警，你知道「嫌疑人」不等於「兇手」，但你也知道十四份記錄裡出現同一個名字不是巧合。你在觀察這個人，你的判決還沒有給出來。",
    bKnowsA: "莊河是退休刑警，他知道那份通話記錄，他在觀察你。你感覺到了他的評估，但他還沒有說他怎麼想。",
    bidirectional: true,
  },
  ...
  // 室友阿傑對玩家：矛盾，想信但有疑問
  {
    ...
    npcB:    "player",
    type:    "connected_by",
    aKnowsB: "你的室友，你住在一起兩年了。你不覺得他是那種人。但警察找了你，告訴你那份通話記錄裡的次數。那個數字讓你很矛盾，你想信他，你也在想你是不是漏了什麼。",
    bKnowsA: "阿傑是你的室友，他知道那份通話記錄的事了。他很矛盾——他不想不信你，但他也有疑問。",
    bidirectional: true,
  },
];
